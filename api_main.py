...
@torch.no_grad()
def run(weights=r"D:\Forbmax User Data\waqar sahi\SmartMeter\yolo\ptv_runs\weights\best.pt",  # model.pt path(s)
...
#     main(source=r"D:\Forbmax User Data\waqar sahi\SmartMeter\yolo\TestDataset")
