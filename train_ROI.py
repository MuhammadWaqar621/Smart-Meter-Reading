...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='Dataset/ROI/data.yaml', help='dataset.yaml path')
...
def process_data():
    ...
    for dirname, _, filenames in os.walk('Dataset/ROI/images'):
        for filename in filenames:
            img_paths.append(os.path.join('Dataset/ROI/images/', filename)) # local machine
    ...
    # write train.txt
    with open("Dataset/ROI/train.txt", 'w') as f:
        lines = list('\n'.join(train))
        f.writelines(lines)
    f.close

    # write validate.txt
    with open('Dataset/ROI/validate.txt', 'w') as f:
        lines = list('\n'.join(validate))
        f.writelines(lines)
    f.close
    ...
    f=open(r"Dataset\ROI\labels\classes.txt",'r')
    names=f.read().split('\n')
    f.close()
    # print(names)
    f=open('Dataset/ROI/data.yaml','w')
    f.write("train: Dataset/ROI/train.txt/")
    f.write("\n")
    f.write("val: Dataset/ROI/validate.txt/")
    f.write("\n")
