...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r"D:\Forbmax User Data\waqar sahi\SmartMeter\yolo\ptv_runs\weights\best.pt", help='model.pt path(s)')
    parser.add_argument('--source', type=str, default=r"D:\Forbmax User Data\waqar sahi\SmartMeter\yolo\TestDataset", help='file/dir/URL/glob, 0 for webcam')
